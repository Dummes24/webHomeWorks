...
--
-- Počítač: localhost
-- Vytvořeno: Stř 08. dub 2020, 17:09
...
(
  ...
  COLLATE = utf8mb4_czech_ci COMMENT ='Tabulka s přehledem kategorií';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_czech_ci COMMENT ='Tabulka s příspěvky';

--
-- Vypisuji data pro tabulku `posts`
--

INSERT INTO `posts` (`post_id`, `user_id`, `category_id`, `text`, `updated`)
VALUES (1, 1, 1, 'Testovací příspěvek', '2020-03-21 00:54:12');
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_czech_ci COMMENT ='Tabulka s daty uživatelů';

--
-- Vypisuji data pro tabulku `users`
--

INSERT INTO `users` (`user_id`, `name`, `email`, `password`, `active`)
VALUES (1, 'Adam', 'adam@domena.tld', '', 1),
       (2, 'Eva', 'eva@domena.tld', '', 1);
